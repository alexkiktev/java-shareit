...
class BookingControllerMockMvcTest {
    ...
    Long userId = 1L;
    User user = new User(userId, "test@test.ru", "Alex");
    Long itemId = 1L;
    Item item = new Item(itemId, "Отвертка", "Крестовая отвертка", true, userId, null);
    Long bookingId = 1L;
    ...
    BookingOutputDto bookingOutputDto =
            new BookingOutputDto(bookingId, dateStart, dateEnd, item, user, null);
    BookingOutputDto approvedBookingOutputDto =
            new BookingOutputDto(bookingId, dateStart, dateEnd, item, user, Status.APPROVED);
