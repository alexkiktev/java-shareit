...
class ItemControllerMockMvcTest {
    ...
    ItemDto newItemDto = new ItemDto(null, "Отвертка", "Крестовая отвертка",
            true, null);
    ItemDto updatedItemDto = new ItemDto(itemId, "Отвертка", "Крестовая отвертка",
            true, null);
    ItemOwnerDto itemOwnerDto = ItemOwnerDto.builder()
            ...
            .comments(null)
            .build();
    ItemOwnerDto itemOwnerDto2 = ItemOwnerDto.builder()
            .id(itemId)
            .name("Дрель")
            ...
            .comments(null)
            .build();
    CommentDto commentDto = new CommentDto(null, "Комментарий", "Имя автора", LocalDateTime.now());
